...
Mother_Q = st.sidebar.slider("Mother qualification", 1, 28, 11.41)
Father_Q = st.sidebar.slider('Father qualification', 1, 28, 11.78)
Mother_O= st.sidebar.slider('Mother occupation', 1, 25, 7.5)
Father_O = st.sidebar.slider("Father occupation", 1, 26, 8.01)
