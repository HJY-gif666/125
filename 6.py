...
st.markdown("""
    ...
    <div style='text-align: center; font-size: 28px;'>Developed by Dr. Songbo Wang et al., Hubei University of Technology.</div>
    <div style='text-align: center; font-size: 28px;'>Email: Wangsongbo@hbut.edu.cn</div>
