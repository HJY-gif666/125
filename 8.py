...
st.markdown("""
    ...
    <div style='text-align: center; font-size: 20px;'>Developed by Dr. Songbo Wang et al., Hubei University of Technology.</div>
    <div style='text-align: center; font-size: 20px;'>Email: Wangsongbo@hbut.edu.cn</div>
...
if st.sidebar.button('Predict'):
    ...
    try:
        ...
        if prediction[0] == 1:
            ...
            # Center the columns
            col1,col2 = st.columns([2,  2])  # Center column is larger
            ...
            # Display images
            col3, col4 = st.columns([2, 2])  # Center column is larger
            with col3:
