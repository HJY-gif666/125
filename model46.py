...
st.write("Data Columns:",feature_values_scaled.columns)  # 输出列名
st.write("Data Preview:", feature_values_scaled.head())  # 输出 DataFrame 的前几行

# 检查是否包含 'Nationality' 列
if 'Nationality' in feature_values_scaled.columns:
    nationality_value =feature_values_scaled.iloc[0]['Nationality']  # 使用 iloc 安全访问
